      ...
      private static List<Transaction> _transactionsList { set; get; }///list For Transaction Entity
        ...
        public void AddTransaction(Transaction t)
        {
            ...
            if (t != null)
            {
                ...
                //Generating the TransactionID --It Will be Generated by Adding 1 to the Last Transaction ID
                int max = 0;
        ...
        public List<Transaction> GetTransactionList(long accountNumber)//returns the last transactions
        {
